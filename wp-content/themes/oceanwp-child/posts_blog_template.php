...
<div class="post hentry ivycat-post row">
	...
	<div class="col-md-7 col-sm-12 col-push-5 stories-right-space" style="font-size: 18px; font-weight: 400;">
		<?php the_excerpt(); ?>
	</div>

	<!-- This will output of the featured image thumbnail  -->
	<div class="col-md-5 col-sm-12 col-push-7">
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'large', array('class' => 'img img-responsive image-shadow') ); ?></a>
	</div>
